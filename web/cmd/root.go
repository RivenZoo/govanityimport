...
var rootCmd = &cobra.Command{
	Use:   "web",
	Short: "Web service for go module http meta",
	Long:  ``,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = views.InitRender()
		if err != nil {
			fmt.Fprintln(os.Stderr, "init reader error: ", err)
			os.Exit(-1)
		}

		ctx := sigutil.RegisterDoneSignal()
		server.StartWebServer(ctx, *listenAddress)
	},
}
...
func init() {
	...
	rpcAddress = rootCmd.Flags().StringP("rpc", "B", "", "module meta info rpc address")
	...
	viper.BindPFlag("web.ModuleServiceAddress", rootCmd.Flags().Lookup("rpc"))
}
